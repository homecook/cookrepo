...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Flags to persist (or un-persist) the login information
     */
    public void onCheckboxClicked(View view) {
        // Is the view now checked?
        boolean checked = ((CheckBox) view).isChecked();
        // Check which checkbox was clicked (we only have one here though...)
        switch(view.getId()) {
            case R.id.checkbox_auto_login:
                if (checked)
                    saveLoginInfo = true;
                // Add the login information to be saved for next time
                else
                    saveLoginInfo = false;
                // Don't add the login information on save
                break;
        }
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, saveLoginInfo);
